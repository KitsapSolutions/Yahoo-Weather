...
method = 'GET'
app_id = 'Yahoo API ID'
consumer_key = 'Yahoo API Client ID'
consumer_secret = 'Yahoo API Client Secret'
concat = '&'
...
signature_base = (method + concat + urllib.parse.quote(url, safe='') + concat + urllib.parse.quote(concat.join(sorted_params), safe='')).encode('utf-8')
